...
class SingleFrameRawDataset(VOSRawDataset):
    ...
    def __init__(self, img_folder, gt_folder, multi_instance=True, file_list_txt=None):
        self.img_folder = img_folder
        self.gt_folder = gt_folder
    ...
    def get_video(self, idx):
        ...
        segment_loader = ConnectedComponentSegmentLoader(mask_path, self.multi_instance)
        return video, segment_loader
